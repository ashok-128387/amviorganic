    ...
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} ${montserrat.variable} scroll-smooth`} suppressHydrationWarning>
      <body className="font-sans antialiased bg-white text-gray-900">
        ...
        <a href="https://wa.me/918748899100" target="_blank" rel="noopener noreferrer"
          ...
          style={{ position: 'fixed', bottom: 24, right: 24, zIndex: 999, background: '#25d366', borderRadius: '50%', width: 56, height: 56, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 16px rgba(0,0,0,0.25)', transition: 'transform 0.2s' }}
